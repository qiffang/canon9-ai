...
var ToolSearchWiki = Tool{
	Name:        "search_wiki",
	Description: "Search across all active wiki pages by keyword. Use when you need to find information not easily located via the index.",
	InputSchema: mustJSON(map[string]any{
		"type": "object",
		"properties": map[string]any{
...
var ToolWriteWikiPage = Tool{
	...
	Description: "Create or update a wiki page. Use to weave new information into existing pages, create new pages, fix errors, or add cross-references.",
	InputSchema: mustJSON(map[string]any{
		"type": "object",
		"properties": map[string]any{
			"path":    map[string]any{"type": "string", "description": "Relative path within wiki/ (e.g. semantic/projects/db9.md)"},
